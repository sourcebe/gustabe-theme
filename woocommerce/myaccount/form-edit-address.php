<?php
/**
 * GUSTABE CUSTOM ADDRESS FORM (V6: Auto-Address Ready)
 * รองรับระบบกรอกที่อยู่อัตโนมัติ (เปลี่ยน Dropdown เป็น Text Input)
 */
    ...
    <form method="post" action="" class="gustabe-auto-form">
        ...
        <div class="form-head-card">
            ...
            <div class="head-info">
                ...
                <p class="head-subtitle">พิมพ์รหัสไปรษณีย์เพื่อค้นหาที่อยู่อัตโนมัติ</p>
            </div>
        </div>
        ...
        <div class="form-body-wrapper">
            ...
            <div class="form-section">
                <div class="section-badge"><i class="huge huge-user-circle"></i> ข้อมูลผู้ติดต่อ</div>
                <div class="form-grid-2">
                    <div class="input-box">
                        ...
                        <div class="input-flex-wrapper">
                            ...
                            <input type="text" name="<?php echo $prefix; ?>first_name" value="<?php echo esc_attr($data['first_name']); ?>" placeholder="ชื่อจริง">
                        </div>
                    </div>
                    <div class="input-box">
                        ...
                        <div class="input-flex-wrapper">
                            <span class="icon-side"><i class="huge huge-user"></i></span>
                            <input type="text" name="<?php echo $prefix; ?>last_name" value="<?php echo esc_attr($data['last_name']); ?>" placeholder="นามสกุล">
                        </div>
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <div class="input-flex-wrapper">
                            ...
                            <input type="tel" name="<?php echo $prefix; ?>phone" value="<?php echo esc_attr($data['phone']); ?>" placeholder="08x-xxx-xxxx">
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="form-section mt-big">
                <div class="section-badge badge-auto"><i class="huge huge-location-01"></i> ระบบค้นหาที่อยู่อัตโนมัติ</div>
                <div class="form-grid-2">

                    <div class="input-box full-width highlight-box">
                        <label>รหัสไปรษณีย์ (พิมพ์เพื่อค้นหา) <span class="req">*</span></label>
                        <div class="input-flex-wrapper">
                            <span class="icon-side"><i class="huge huge-search-02"></i></span>
                            <input type="text" id="<?php echo $prefix; ?>postcode" name="<?php echo $prefix; ?>postcode" value="<?php echo esc_attr($data['postcode']); ?>" placeholder="พิมพ์รหัสไปรษณีย์ เช่น 10900..." autocomplete="off">
                        </div>
                        <small style="color:#04a39c; display:block; margin-top:5px;">* พิมพ์ตัวเลขแล้วเลือกระบบจะกรอก จังหวัด/อำเภอ/ตำบล ให้เอง</small>
                    </div>

                    <div class="input-box full-width">
                        <label>บ้านเลขที่ / หมู่บ้าน / ซอย <span class="req">*</span></label>
                        <div class="input-flex-wrapper">
                            <span class="icon-side"><i class="huge huge-home-01"></i></span>
                            <input type="text" name="<?php echo $prefix; ?>address_1" value="<?php echo esc_attr($data['address_1']); ?>" placeholder="ระบุบ้านเลขที่...">
                        </div>
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <div class="input-flex-wrapper">
                            ...
                            <input type="text" id="<?php echo $prefix; ?>address_2" name="<?php echo $prefix; ?>address_2" value="<?php echo esc_attr($data['address_2']); ?>" placeholder="ตำบล / แขวง">
                        </div>
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <div class="input-flex-wrapper">
                            ...
                            <input type="text" id="<?php echo $prefix; ?>city" name="<?php echo $prefix; ?>city" value="<?php echo esc_attr($data['city']); ?>" placeholder="เขต / อำเภอ">
                        </div>
                    </div>
                    ...
                    <div class="input-box full-width">
                        ...
                        <div class="input-flex-wrapper">
                            ...
                            <input type="text" id="<?php echo $prefix; ?>state" name="<?php echo $prefix; ?>state" value="<?php echo esc_attr($data['state']); ?>" placeholder="จังหวัด">
                        </div>
                    </div>
            ...
            <div class="form-footer-action">
                <button type="submit" class="gustabe-save-btn" name="save_address" value="<?php esc_attr_e( 'Save address', 'woocommerce' ); ?>">
                    <i class="huge huge-checkmark-circle-02"></i> บันทึกที่อยู่
                </button>
...
<style>
    ...
    .input-flex-wrapper { display: flex; align-items: center; background: #fcfcfc; border: 1px solid #e0e0e0; border-radius: 10px; /* overflow: hidden; ลบอันนี้ออก */ transition: all 0.3s ease; height: 50px; }
    ...
    /* Override jquery.Thailand.js Suggestion Box (ให้เข้ากับธีม) */
    .tt-menu { 
        background: #fff; border: 1px solid #eee; border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); margin-top: 5px; width: 100%; 
    }
