...
<div class="fixed bottom-0 left-0 w-full h-[65px] bg-slate-950/80 backdrop-blur-xl border-t border-white/10 z-[9000] flex font-sans lg:hidden shadow-[0_-5px_20px_rgba(0,0,0,0.5)]">
    ...
    <!-- 1. ปุ่ม Home -->
    <a href="<?php echo esc_url($home_url); ?>" class="flex-1 flex flex-col items-center justify-center transition-colors <?php echo $is_home ? 'text-blue-400' : 'text-slate-500 hover:text-blue-300 hover:bg-white/5'; ?>">
    ...
    <!-- 2. ปุ่ม Shop -->
    <a href="<?php echo esc_url($shop_url); ?>" class="flex-1 flex flex-col items-center justify-center transition-colors border-l border-white/5 <?php echo $is_shop ? 'text-blue-400' : 'text-slate-500 hover:text-blue-300 hover:bg-white/5'; ?>">
    ...
    <a href="<?php echo esc_url($cart_url); ?>" class="flex-1 flex flex-col items-center justify-center transition-colors border-l border-white/5 <?php echo $is_cart ? 'text-blue-400' : 'text-slate-500 hover:text-blue-300 hover:bg-white/5'; ?>">
        <div class="relative">
    ...
    <!-- 4. ปุ่ม Chat (Line) -->
    <a href="<?php echo esc_url($line_link); ?>" target="_blank" rel="noopener noreferrer" class="flex-1 flex flex-col items-center justify-center text-slate-500 hover:text-blue-300 hover:bg-white/5 transition-colors border-l border-white/5">
    ...
    <!-- 5. ปุ่ม Account -->
    <a href="<?php echo esc_url($myaccount_url); ?>" class="flex-1 flex flex-col items-center justify-center transition-colors border-l border-white/5 <?php echo $is_account ? 'text-blue-400' : 'text-slate-500 hover:text-blue-300 hover:bg-white/5'; ?>">
