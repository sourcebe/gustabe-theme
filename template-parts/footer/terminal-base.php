        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div class="flex flex-col">
                <div class="mb-4 text-2xl font-bold tracking-tighter flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080" class="w-8 h-8 rounded-xl transition-transform duration-300 hover:scale-110 drop-shadow-[0_0_8px_rgba(255,0,0,0.5)]">
