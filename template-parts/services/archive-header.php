...
global $wp_query;
?>
<section class="relative pt-24 pb-16 bg-[#050505] border-b border-slate-900 overflow-hidden">
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-green-600/5 blur-[120px] rounded-full pointer-events-none"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="font-mono mb-6">
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-white tracking-tighter">
                Available <span class="text-green-500">Modules</span>
            </h1>
